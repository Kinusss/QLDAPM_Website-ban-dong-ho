				...
				<tbody>
					@foreach($nguoidung as $value)
						<tr>
							...
							<td class="text-center"><a href="{{ route('admin.nguoidung.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa người dùng &quot;{{ $value->name }}&quot; không?');"><i class="bi bi-trash text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
