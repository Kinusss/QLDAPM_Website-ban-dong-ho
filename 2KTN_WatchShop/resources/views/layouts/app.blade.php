            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link" href="{{ route('admin.hangsanxuat') }}"><i class="bi bi-boxes"></i> Hãng sản xuất</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="{{ route('admin.sanpham') }}"><i class="bi bi-box"></i> Sản phẩm</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="{{ route('admin.tinhtrang') }}"><i class="bi bi-chat-square-quote"></i> Tình trạng</a>
						</li>
						<li class="nav-item">
