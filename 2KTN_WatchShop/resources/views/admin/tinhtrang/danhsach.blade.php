				...
				<tbody>
					@foreach($tinhtrang as $value)
						<tr>
							...
							<td class="text-center"><a href="{{ route('admin.tinhtrang.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa &quot;{{ $value->tinhtrang }}&quot; không?');"><i class="bi bi-trash text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
