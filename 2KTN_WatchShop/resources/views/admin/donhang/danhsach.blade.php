			...
			<table class="table table-bordered table-hover table-sm mb-0">
				...
				<tbody>
					@foreach($donhang as $value)
						...
						<td class="text-center"><a href="{{ route('admin.donhang.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa mục này?');"><i class="bi bi-trash text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
