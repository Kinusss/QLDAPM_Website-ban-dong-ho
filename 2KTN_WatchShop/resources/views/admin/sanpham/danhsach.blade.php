			...
			<table class="table table-bordered table-hover table-sm mb-3">
				...
				<tbody>
					@foreach($sanpham as $value)
							...
							<td class="text-center"><a href="{{ route('admin.sanpham.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm &quot;{{ $value->tensanpham }}&quot; không?');"><i class="bi bi-trash text-danger"></i></a></td>
						</tr>
				@endforeach
				</tbody>
			</table>
