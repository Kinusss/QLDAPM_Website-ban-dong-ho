				...
				<tbody>
					@foreach($loaisanpham as $value)
						<tr>
							...
							<td class="text-center"><a href="{{ route('admin.loaisanpham.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa mục &quot;{{ $value->tenloai }}&quot; không?');"><i class="bi bi-trash text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
