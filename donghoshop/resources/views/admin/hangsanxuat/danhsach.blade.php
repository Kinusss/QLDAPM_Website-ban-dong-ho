				...
				<tbody>
					@foreach($hangsanxuat as $value)
						<tr>
							...
							<td class="text-center"><a href="{{ route('admin.hangsanxuat.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa hãng sản xuất &quot;{{ $value->tenhang }}&quot; không?');"><i class="bi bi-trash text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
