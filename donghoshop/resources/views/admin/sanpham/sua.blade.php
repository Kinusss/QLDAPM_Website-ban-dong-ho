        ...
        <form action="{{ route('sanpham.sua', ['id' => $sanpham->id]) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="0" class="form-control @error('soluong') is-invalid @enderror" id="soluong"
                    name="soluong" value="{{ $sanpham->soluong }}" required />
                @error('soluong')
                <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" min="0" class="form-control @error('dongia') is-invalid @enderror" id="dongia"
                    name="dongia" value="{{ $sanpham->dongia }}" required />
                @error('dongia')
                <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <img class="d-block rounded img-thumbnail"
                    src="{{ env('APP_URL') . '/storage/app/' . $sanpham->hinhanh }}" width="100" />
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="motasanpham"
                    name="motasanpham">{{ $sanpham->motasanpham }}</textarea>
            </div>
